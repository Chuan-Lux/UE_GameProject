...
extern "C"
{
    ...
    */
    ...
    /// For the index to be valid, it must be greater or equal to 0 and less than GetStateesCount.
    ...
    */
    ...
    /// Delete an array containing all the AcousticTexturees. This should be called upon exiting the scope of the array.
    ...
    /// For the index to be valid, it must be greater or equal to 0 and less than GetAcousticTextureesCount.
    ...
    */
    ...
    /// Delete an array containing all the GameParameteres. This should be called upon exiting the scope of the array.
    ...
    /// For the index to be valid, it must be greater or equal to 0 and less than GetGameParameteresCount.
    ...
    */
    ...
    /// Delete an array containing all the Triggeres. This should be called upon exiting the scope of the array.
    ...
    /// For the index to be valid, it must be greater or equal to 0 and less than GetTriggeresCount.
